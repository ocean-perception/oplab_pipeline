...
class TestAcfrStereoPose(unittest.TestCase):
    def setUp(self):
        data = (
            ...
            "-7.3547900343418879 	48.1042130295795403 	-83.5766631892393974"  # noqa
            " 	962.3138844564567762 	-0.0116629178991342 	0.0592197626619286"  # noqa
            ...
            "-7.3548417967423685 	48.1023177169713634 	-86.4800384045786785"  # noqa
            " 	962.2779424463255964 	-0.0106603074717418 	0.0516333356444368"  # noqa
            ...
            "-7.3548932724292806 	48.0333504624794756 	-89.3673333486288186"  # noqa
            " 	962.3690214898499562 	-0.0069141654804990 	0.0493079909303522"  # noqa
            " 	-0.0038653766339864 	PCO_190916090512963283_FC.png 	"
            "PCO_190916090512963081_AC.png 	4.2279998283386231 	3.1439310358278716 	1"  # noqa
        )
    ...
    def test_acfr_stereo_pose(self):
        ...
        self.assertAlmostEqual(
            s._entries[0].stamp, 1568624706.9503738880157471
        )
        ...
        self.assertEqual(
            s._entries[0].left_image_name, "PCO_190916090506950374_FC.png"
        )
        self.assertEqual(
        ...
        self.assertAlmostEqual(
            s._entries[0].bounding_image_radius, 3.2025993712939327
        )
