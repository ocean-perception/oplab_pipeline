...
![The process workflow is illustrated below - ](https://github.com/ocean-perception/oplab_pipeline/blob/develop/docs/images/process_workflow.png "Process Workflow")
